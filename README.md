...
- 🎓 **Education:** 6th year Computer Engineering student at Costa Rica Institute of Technology (Graduation: July 2027)
...
- ✅ Implemented full **MESI protocol** (Modified, Exclusive, Shared, Invalid) with snooping mechanisms
- ✅ Built **interactive GUI** for real-time visualization of cache states and memory operations
- ✅ Developed **write-back cache** with LRU replacement policy
- ✅ Applied **C++ multithreading** with mutexes, semaphores, and condition variables
...
### ⚡ [ARMv4 Processor Design & Verification](https://github.com/JoseAndresVargasTorres/jVargas_kZheng_jEspinoza_final_proyect_2024)
*Complete ARMv4 pipelined processor in Verilog with functional verification*  
...
**🎯 Key Achievements:**
- ✅ Designed complete **ARMv4 pipelined processor** with datapath, control unit, and memory subsystem
- ✅ Developed **testbenches** for functional verification using ModelSim
- ✅ Synthesized design on **Altera DE1-SoC FPGA** (Cyclone V)
- ✅ Applied **logic design principles** for ALU, register file, and instruction decoder
- ✅ Debugged timing issues and verified correct instruction execution

**📊 Technical Highlights:**
- Verilog HDL design and synthesis
- Testbench development for processor verification
...
- ✅ **Battleship Game:** Complex FSM logic with hardware randomization
- ✅ **Verification:** Assertions, coverage analysis, corner case testing

**📊 Technical Highlights:**
- SystemVerilog testbench development
- Verification methodologies and best practices
- FPGA synthesis and implementation on DE1-SoC
...
*Advanced synchronization techniques for concurrent systems*  
![C](https://img.shields.io/badge/C-00599C?style=flat-square&logo=c&logoColor=white)
![Multithreading](https://img.shields.io/badge/Multithreading-FF6B6B?style=flat-square)
![POSIX](https://img.shields.io/badge/POSIX-FCC624?style=flat-square)

**🎯 Key Achievements:**
- ✅ Implemented **synchronization primitives** (mutexes, semaphores, condition variables)
- ✅ Solved **race conditions** between heavy processes
- ✅ Focused on **performance optimization** and deadlock prevention
- ✅ Low-level C programming with concurrent patterns

**📊 Technical Highlights:**
- Resource management in multiprocess environments
...
*Full-stack application with clean architecture and microservices*  
...
- ✅ **Frontend:** Angular 20.3.5 with TypeScript
...
- **Computer Architecture II:** Cache coherence, multiprocessor systems, performance optimization
- **Digital Design:** SystemVerilog/Verilog HDL, FPGA synthesis, testbench development
- **Operating Systems:** Process synchronization, concurrency, resource management
- **Data Structures & Algorithms:** Algorithm optimization, complexity analysis
...
⚡ **Fun fact:** I combine competitive table tennis coaching with computer architecture – both require strategic thinking, pattern recognition, and optimization! 🏓💻
