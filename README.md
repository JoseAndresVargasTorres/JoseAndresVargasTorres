...
- Designed and implemented a **multiprocessor cache coherence system** using the MESI protocol
- Built a **parallel dot product** case study to demonstrate synchronization efficiency
- Developed interactive **GUI for real-time visualization** of cache states and memory operations
- Applied advanced computer architecture concepts for performance optimization
...
- Utilized **mutexes, semaphores, and condition variables** for resource management
- Focused on **performance optimization** and deadlock prevention
- Low-level C programming with emphasis on concurrent programming patterns
...
- **Backend:** ASP.NET Core API with clean architecture and dependency injection
- **Frontend:** Angular 20.3.5 with TypeScript for dynamic user interface
- Implemented **C2 architecture diagrams** and Azure deployment infrastructure
- Applied **Agile/Scrum methodology** with multiple sprint cycles and refactoring
- Created comprehensive **unit tests** and API documentation
- **Team collaboration:** User stories, code reviews, and pull request management
- Emphasis on **scalability, maintainability, and cloud deployment**
...
![Robotics](https://img.shields.io/badge/Robotics-00629B?style=flat-square)
...
**🔗 View all repositories:** [github.com/JoseAndresVargasTorres](https://github.com/JoseAndresVargasTorres)
